...
function createSeedData(name = "User") {
  ...
  return {
    ...
    investments: [
      ...
      { id: "inv2", symbol: "MSFT", quantity: 30, buyPriceCents: 32e3 },
      { id: "inv3", symbol: "TSLA", quantity: 20, buyPriceCents: 25e3 },
      { id: "inv4", symbol: "VOO", quantity: 40, buyPriceCents: 4e4 }
    ],
    // Loans
    loans: [
      { id: "loan1", name: "Mortgage", principalRemainingCents: 25e6 },
      { id: "loan2", name: "Car Loan", principalRemainingCents: 12e5 }
    ],
    // Assets
    assets: [
      {
      ...
      { id: "asset3", name: "Car", type: "Vehicle", valueCents: 25e5 },
      {
        id: "asset4",
        name: "Luxury Watch",
        type: "Luxury",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: 0 }, children: "Higgs" }),
        ...
        !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { style: { display: "grid", gap: 8 }, children: [
          PAGES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                padding: "10px 12px",
                borderRadius: 8,
                border: currentPage === p.key ? "1px solid #111" : "1px solid #ddd",
...
function ExpensePage({ onAdded }) {
  ...
  function handleSubmit(e) {
    ...
    data.monthly[month].byCategory[category] = (data.monthly[month].byCategory[category] || 0) + exp.amountCents;
    save(data);
    onAdded();
    setDate("");
    setAmount("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-wrapper", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Add Expense" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Add Expense" })
    ] })
  ] });
}
function IncomePage({ onAdded }) {
  const [date, setDate] = reactExports.useState("");
  const [amount, setAmount] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-wrapper", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Add Income" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Date" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-col", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: source, onChange: (e) => setSource(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Note (optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: note, onChange: (e) => setNote(e.target.value) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Add Income" })
    ] })
  ] });
}
...
function App() {
  const meta = getMeta();
  const [onboarded, setOnboarded] = reactExports.useState(meta.onboarded);
  const [name, setName] = reactExports.useState("");
  const [data, setData] = reactExports.useState(load());
  ...
  if (!onboarded) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-root", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "welcome-title", children: "Higgs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "welcome-subtitle", children: "Let's set up your personal finance space." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "welcome-label", children: "WHAT SHOULD WE CALL YOU?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "welcome-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              value: name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "welcome-hint", children: "You can reset everything anytime from the sidebar." })
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: { padding: 16 }, children: [
          page === "home" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Total Net Worth: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: dollars(m.netWorthCents) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Income this month: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginTop: 16 }, children: [
              "By Category:",
              " ",
              Object.entries(m.byCategory).map(([k, v]) => `${k}: ${dollars(v)}`).join(" | ")
            ] })
          ] }),
          page === "income" && /* @__PURE__ */ jsxRuntimeExports.jsx(IncomePage, { onAdded: refreshData }),
